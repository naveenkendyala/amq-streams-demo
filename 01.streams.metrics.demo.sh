...
#
oc apply -f ocp-install-examples/amq-streams-2.2.0/examples/metrics/prometheus-install/strimzi-pod-monitor.yaml
#
oc apply -f ocp-install-examples/amq-streams-2.2.0/examples/metrics/prometheus-install/prometheus-rules.yaml
#
oc apply -f ocp-install-examples/amq-streams-2.2.0/examples/metrics/prometheus-install/prometheus.yaml


#Install grafana dashboard
oc apply -f ocp-install-examples/amq-streams-2.2.0/examples/metrics/grafana-install/grafana.yaml
