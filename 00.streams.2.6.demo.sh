...
# Operator Install : AMQ Streams [Provided by Red Hat] 2.5.x
# Operator Install : Prometheus [Community] in "myproject"
...
oc apply -f ocp-install-examples/amq-streams-2.5.0/examples/metrics/kafka-metrics.yaml

###Prometheus
#
oc create secret generic additional-scrape-configs --from-file=ocp-install-examples/amq-streams-2.2.0/examples/metrics/prometheus-additional-properties/prometheus-additional.yaml
#
oc apply -f ocp-install-examples/amq-streams-2.5.0/examples/metrics/prometheus-install/strimzi-pod-monitor.yaml
#
oc apply -f ocp-install-examples/amq-streams-2.5.0/examples/metrics/prometheus-install/prometheus-rules.yaml
#
oc apply -f ocp-install-examples/amq-streams-2.5.0/examples/metrics/prometheus-install/prometheus.yaml


#Install grafana dashboard
oc apply -f ocp-install-examples/amq-streams-2.5.0/examples/metrics/grafana-install/grafana.yaml
